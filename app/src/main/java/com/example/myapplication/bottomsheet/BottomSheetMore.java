...
public class BottomSheetMore extends BottomSheetDialogFragment {
    ...
    public BottomSheetMore(Context context, Activity activity) {
    ...
    private List<MediaItem> getAllMedia() {
        ...
        @SuppressLint("UseCompatLoadingForDrawables") Drawable cameraIconDrawable = resources.getDrawable(R.drawable.icon_camera);
        String cameraIconPath = convertDrawableToPath(cameraIconDrawable);
        ...
        if (cursor != null) {
            ...
            while (cursor.moveToNext()) {
                ...
                boolean isVideo = cursor.getType(columnIndex) == Cursor.FIELD_TYPE_STRING;
    ...
    private String convertDrawableToPath(Drawable drawable) {
        Bitmap bitmap = ((BitmapDrawable) drawable).getBitmap();
        File cachePath = new File(context.getCacheDir(), "images");
        cachePath.mkdirs();
        File imagePath = new File(cachePath, "camera_icon.png");
