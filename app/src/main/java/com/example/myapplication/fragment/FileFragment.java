...
import com.example.myapplication.adapter.FileMessagesAdapter;
...
public class FileFragment extends Fragment {
    ...
    private FileMessagesAdapter fileMessagesAdapter;
    public FileFragment() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fileMessagesAdapter = new FileMessagesAdapter(requireContext(), requireActivity(), messagesModelArrayList);
        rv_media.setAdapter(fileMessagesAdapter);
                        ...
                        try {
                            ...
                            if (status) {
                                ...
                                for (int i = 0; i < dataArray.length(); i++) {
                                    ...
                                    Log.d(">>>>>>>>>>>>>>>>>", "onViewCreated: "+typeMessage);
                                }
                                ...
                                requireActivity().runOnUiThread(() -> {
                                    ...
                                    fileMessagesAdapter.notifyDataSetChanged();
                                });
                            } else {
                                requireActivity().runOnUiThread(() -> {
    ...
    public void onResume() {
        ...
        if (messages_list_id != 0) {
            getMessageList(messages_list_id, 4);
        }
    }
}