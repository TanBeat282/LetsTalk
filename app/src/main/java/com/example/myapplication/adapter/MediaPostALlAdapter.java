...
public class MediaPostALlAdapter extends RecyclerView.Adapter<MediaPostALlAdapter.ViewHolder> {
    private List<ImagePostModel> imagePostModels;
    private Context context;
    private Activity mActivity;
    private final int YOUR_REQUEST_CODE = 12345;

    public MediaPostALlAdapter(Context context, Activity mActivity, List<ImagePostModel> imagePostModels) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("url_media", imagePostModel.getImage());
